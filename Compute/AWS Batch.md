...
+ ==Lots of jobs==<br>running on ==vast<br>resources==
...
+==Parameters== for<br>running Jobs
...
+Ordered List of<br>scheduled jobs
+Job Queues  
...
+Contain compute<br> resources. Can be<br> managed or<br>unmanaged
...
• Greater customization, but requires more admin • You have to create the Amazon ECS cluster yourself
```